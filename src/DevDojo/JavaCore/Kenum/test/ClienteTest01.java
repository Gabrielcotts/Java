...
import DevDojo.JavaCore.Kenum.dominio.Cliente_Com_Enum;
import DevDojo.JavaCore.Kenum.dominio.Cliente_Sem_Enum;
 ...
 */
        ...
        Cliente_Com_Enum cliente01 = new Cliente_Com_Enum("Luciene", TipoCliente.PESSOA_FISICA);
        Cliente_Com_Enum cliente02 = new Cliente_Com_Enum("Erivaldo", TipoCliente.PESSOA_JURIDICA);
        Cliente_Com_Enum cliente03 = new Cliente_Com_Enum("Tonhão", TipoCliente.PESSOA_FISICA);
        Cliente_Com_Enum cliente04 = new Cliente_Com_Enum("Eva", TipoCliente.PESSOA_FISICA);
